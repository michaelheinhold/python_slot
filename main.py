...
def get_bet():
  while True:
    lines = input("Enter the amount to bet on each line. $")
    if lines.isdigit():
      lines = int(lines)
...
def game(balance):
  ...
  while True:
    ...
    if total_bet > balance:
      print(f"You do not have enough to bet that amount, your current balance is ${balance} and you are attempting to bet ${total_bet}.")
    else:
      break
